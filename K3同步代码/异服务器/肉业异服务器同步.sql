...
--EXEC sp_helptext 'Ly_GetICBillNo'
-- 源   Test_yxry2
---目标 CON14.AIS_yxry2_2
---部署bos开发
...
Delete ICClassType WHERE FID=200000004
GO
...
VALUES (200000004,'同步数据配置表','基礎資料200000004','Master Data200000004',0,'t_YXSet',0,200000004,'',0,3,11895,3885,'',23,'',1,0,'',0,1,'CHS=;CHT=;EN=','FID','FEntryID','FClassTypeID','FIndex',4100,200000004,2101,2102,'',1,80000294,1075775667,NULL,''
) --,'','FPGUID','FEGUID'
GO

/****** Object:Data   单据分录描述：ICClassTypeEntry    Script Date: 2013-09-06 ******/

Delete ICClassTypeEntry WHERE FParentID=200000004
GO
...
VALUES (1,200000004,'t_YXSet',0,2190,6000,4740,0,0,0,1,'','','','','',1,'') --,1,1
GO

INSERT INTO ICClassTypeEntry(FIndex,FParentID,FTableName,FLeft,FTop,FWidth,FHeight,FLayer,FEntryType,FTabIndex,FMustInput,FKeyField,FDescription_CHS,FDescription_CHT,FDescription_EN,FFilter,FUserDefine,FContainer
) --,FCanSort,FParentEntry
VALUES (2,200000004,'t_YXSetEntry',2775,5010,870,645,0,0,5,1,'','','','','',1,'') --,1,1
GO

/****** Object:Data   单据模板字段描述：ICClassTableInfo    Script Date: 2013-09-06 ******/

Delete ICClassTableInfo WHERE FClassTypeID=200000004
GO
...
VALUES (200000004,1,'代码','代碼','Code','FNumber','FNumber','t_YXSet','',2,1,2047,1,1,0,1,'',0,0,'','','','','','',1,'','',167,500,255,255,'','','SetEquation{FParentNumber}',1,'代码','',610,1125,350,2200,'0,13',0,24,0,0,0,0,'',8193,'',0,'','',0,0,0,0,0,0,0,'',0) 
GO

INSERT INTO ICClassTableInfo(FClassTypeID,FPage,FCaption_CHS,FCaption_CHT,FCaption_EN,FKey,FFieldName,FTableName,FTableNameAs,FListIndex,FListClassName,FVisible,FEnable,FNeedSave,FMustInput,FCtlType,FProperty,FLookUpType,FLookUpClassID,FLookUpList,FSRCFieldName,FSRCTableName,FSRCTableNameAs,FDSPFieldName,FFNDFieldName,FValueLocation,FFilter,FFilterGroup,FValueType,FDspColType,FEditlen,FValuePrecision,FSaveRule,FDefValue,FAction,FUserDefine,FNote,FKeyWord,FLeft,FTop,FHeight,FWidth,FCondition,FTabIndex,FLock,FSum,FPrec,FScale,FLayer,FLoadAction,FUnControl,FFont,FSourceType,FSubKey,FParentKey,FConditionExt,FFrameBorder,FFrameBorderColor,FLabelWidth,FLabelColor,FTextColor,FIsF7,FContainer,FStyle) 
VALUES (200000004,1,'是否明细','是否明細','Details (Y/N)','FDetail','FDetail','t_YXSet','',21,2,0,1,1,1,1,'',0,0,'','','','','','',1,'','',104,500,255,48,'','','',1,'是否明细','DETAIL',240,120,350,0,'-1',1,24,0,0,0,0,'',8193,'',0,'','',0,0,0,0,0,0,0,'',0) 
GO

INSERT INTO ICClassTableInfo(FClassTypeID,FPage,FCaption_CHS,FCaption_CHT,FCaption_EN,FKey,FFieldName,FTableName,FTableNameAs,FListIndex,FListClassName,FVisible,FEnable,FNeedSave,FMustInput,FCtlType,FProperty,FLookUpType,FLookUpClassID,FLookUpList,FSRCFieldName,FSRCTableName,FSRCTableNameAs,FDSPFieldName,FFNDFieldName,FValueLocation,FFilter,FFilterGroup,FValueType,FDspColType,FEditlen,FValuePrecision,FSaveRule,FDefValue,FAction,FUserDefine,FNote,FKeyWord,FLeft,FTop,FHeight,FWidth,FCondition,FTabIndex,FLock,FSum,FPrec,FScale,FLayer,FLoadAction,FUnControl,FFont,FSourceType,FSubKey,FParentKey,FConditionExt,FFrameBorder,FFrameBorderColor,FLabelWidth,FLabelColor,FTextColor,FIsF7,FContainer,FStyle) 
VALUES (200000004,1,'类别','類別','Category','FClassTypeID','FClassTypeID','t_YXSet','',22,2,0,1,1,1,1,'',0,0,'','','','','','',1,'','',231,500,255,48,'','','',1,'类别','CLASSTYPEID',240,120,350,0,'-1',2,24,0,0,0,0,'',8193,'',0,'','',0,0,0,0,0,0,0,'',0) 
GO

INSERT INTO ICClassTableInfo(FClassTypeID,FPage,FCaption_CHS,FCaption_CHT,FCaption_EN,FKey,FFieldName,FTableName,FTableNameAs,FListIndex,FListClassName,FVisible,FEnable,FNeedSave,FMustInput,FCtlType,FProperty,FLookUpType,FLookUpClassID,FLookUpList,FSRCFieldName,FSRCTableName,FSRCTableNameAs,FDSPFieldName,FFNDFieldName,FValueLocation,FFilter,FFilterGroup,FValueType,FDspColType,FEditlen,FValuePrecision,FSaveRule,FDefValue,FAction,FUserDefine,FNote,FKeyWord,FLeft,FTop,FHeight,FWidth,FCondition,FTabIndex,FLock,FSum,FPrec,FScale,FLayer,FLoadAction,FUnControl,FFont,FSourceType,FSubKey,FParentKey,FConditionExt,FFrameBorder,FFrameBorderColor,FLabelWidth,FLabelColor,FTextColor,FIsF7,FContainer,FStyle) 
VALUES (200000004,1,'父级内码','父級內碼','Parent ISN','FParentID','FParentID','t_YXSet','',5,2,0,1,1,1,3,'',0,0,'','','','','','',1,'','',56,500,255,4,'','','',1,'父级内码','GRPPARENTID',0,0,0,0,'-1',4,24,0,0,0,0,'',8193,'',0,'','',0,0,0,0,0,0,0,'',0) 
GO

INSERT INTO ICClassTableInfo(FClassTypeID,FPage,FCaption_CHS,FCaption_CHT,FCaption_EN,FKey,FFieldName,FTableName,FTableNameAs,FListIndex,FListClassName,FVisible,FEnable,FNeedSave,FMustInput,FCtlType,FProperty,FLookUpType,FLookUpClassID,FLookUpList,FSRCFieldName,FSRCTableName,FSRCTableNameAs,FDSPFieldName,FFNDFieldName,FValueLocation,FFilter,FFilterGroup,FValueType,FDspColType,FEditlen,FValuePrecision,FSaveRule,FDefValue,FAction,FUserDefine,FNote,FKeyWord,FLeft,FTop,FHeight,FWidth,FCondition,FTabIndex,FLock,FSum,FPrec,FScale,FLayer,FLoadAction,FUnControl,FFont,FSourceType,FSubKey,FParentKey,FConditionExt,FFrameBorder,FFrameBorderColor,FLabelWidth,FLabelColor,FTextColor,FIsF7,FContainer,FStyle) 
VALUES (200000004,1,'名称','名稱','Name','FName','FName','t_YXSet','',4,1,12,1,1,0,1,'',0,0,'','','','','','',1,'','',167,500,255,255,'','','SetEquation{FParentName}',1,'名称','',2695,3840,350,2200,'0,13',5,24,0,0,0,0,'',8193,'',0,'','',0,0,0,0,0,0,0,'',0) 
GO

INSERT INTO ICClassTableInfo(FClassTypeID,FPage,FCaption_CHS,FCaption_CHT,FCaption_EN,FKey,FFieldName,FTableName,FTableNameAs,FListIndex,FListClassName,FVisible,FEnable,FNeedSave,FMustInput,FCtlType,FProperty,FLookUpType,FLookUpClassID,FLookUpList,FSRCFieldName,FSRCTableName,FSRCTableNameAs,FDSPFieldName,FFNDFieldName,FValueLocation,FFilter,FFilterGroup,FValueType,FDspColType,FEditlen,FValuePrecision,FSaveRule,FDefValue,FAction,FUserDefine,FNote,FKeyWord,FLeft,FTop,FHeight,FWidth,FCondition,FTabIndex,FLock,FSum,FPrec,FScale,FLayer,FLoadAction,FUnControl,FFont,FSourceType,FSubKey,FParentKey,FConditionExt,FFrameBorder,FFrameBorderColor,FLabelWidth,FLabelColor,FTextColor,FIsF7,FContainer,FStyle) 
VALUES (200000004,1,'菜单控制','功能表控制','Menu Control','FLogic','FLogic','t_YXSet','',0,2,0,1,0,1,3,'',0,0,'','','','','','',1,'','',56,500,255,4,'','','',1,'内码','',240,120,350,0,'-1',7,24,0,0,0,0,'',8193,'',0,'','',0,0,0,0,0,0,0,'',0) 
GO

INSERT INTO ICClassTableInfo(FClassTypeID,FPage,FCaption_CHS,FCaption_CHT,FCaption_EN,FKey,FFieldName,FTableName,FTableNameAs,FListIndex,FListClassName,FVisible,FEnable,FNeedSave,FMustInput,FCtlType,FProperty,FLookUpType,FLookUpClassID,FLookUpList,FSRCFieldName,FSRCTableName,FSRCTableNameAs,FDSPFieldName,FFNDFieldName,FValueLocation,FFilter,FFilterGroup,FValueType,FDspColType,FEditlen,FValuePrecision,FSaveRule,FDefValue,FAction,FUserDefine,FNote,FKeyWord,FLeft,FTop,FHeight,FWidth,FCondition,FTabIndex,FLock,FSum,FPrec,FScale,FLayer,FLoadAction,FUnControl,FFont,FSourceType,FSubKey,FParentKey,FConditionExt,FFrameBorder,FFrameBorderColor,FLabelWidth,FLabelColor,FTextColor,FIsF7,FContainer,FStyle) 
VALUES (200000004,1,'内码','內碼','ISN','FID','FID','t_YXSet','',0,1,0,1,1,1,3,'',0,0,'','','','','','',1,'','',56,500,255,4,'','','',1,'内码','PRIMARY',240,120,350,0,'-1',8,24,0,0,0,0,'',8193,'',0,'','',0,0,0,0,0,0,0,'',0) 
GO

INSERT INTO ICClassTableInfo(FClassTypeID,FPage,FCaption_CHS,FCaption_CHT,FCaption_EN,FKey,FFieldName,FTableName,FTableNameAs,FListIndex,FListClassName,FVisible,FEnable,FNeedSave,FMustInput,FCtlType,FProperty,FLookUpType,FLookUpClassID,FLookUpList,FSRCFieldName,FSRCTableName,FSRCTableNameAs,FDSPFieldName,FFNDFieldName,FValueLocation,FFilter,FFilterGroup,FValueType,FDspColType,FEditlen,FValuePrecision,FSaveRule,FDefValue,FAction,FUserDefine,FNote,FKeyWord,FLeft,FTop,FHeight,FWidth,FCondition,FTabIndex,FLock,FSum,FPrec,FScale,FLayer,FLoadAction,FUnControl,FFont,FSourceType,FSubKey,FParentKey,FConditionExt,FFrameBorder,FFrameBorderColor,FLabelWidth,FLabelColor,FTextColor,FIsF7,FContainer,FStyle) 
VALUES (200000004,1,'同步表单名称','下拉清單','Drop-down List','FComboBox','FTableName','t_YXSetEntry','',2,1,2047,0,1,1,8,'',0,0,'VALUELIST{1=同步外购入库单,2=同步采购发票,3=同步付款单,4=同步销售出库单,5=同步销售发票,6=同步收款单,7=同步生产领料单,8=同步产品入库单,9=同步其他入库单,10=同步其他出库单,11=同步记账凭证}','','','','','',1,'','',231,500,255,255,'','','',1,'','',3240,1200,315,4275,'5',29,24,0,0,0,0,'',24631,'',9,'','',0,2,0,0,0,0,0,'',0) 
GO

INSERT INTO ICClassTableInfo(FClassTypeID,FPage,FCaption_CHS,FCaption_CHT,FCaption_EN,FKey,FFieldName,FTableName,FTableNameAs,FListIndex,FListClassName,FVisible,FEnable,FNeedSave,FMustInput,FCtlType,FProperty,FLookUpType,FLookUpClassID,FLookUpList,FSRCFieldName,FSRCTableName,FSRCTableNameAs,FDSPFieldName,FFNDFieldName,FValueLocation,FFilter,FFilterGroup,FValueType,FDspColType,FEditlen,FValuePrecision,FSaveRule,FDefValue,FAction,FUserDefine,FNote,FKeyWord,FLeft,FTop,FHeight,FWidth,FCondition,FTabIndex,FLock,FSum,FPrec,FScale,FLayer,FLoadAction,FUnControl,FFont,FSourceType,FSubKey,FParentKey,FConditionExt,FFrameBorder,FFrameBorderColor,FLabelWidth,FLabelColor,FTextColor,FIsF7,FContainer,FStyle) 
VALUES (200000004,1,'指定审核人员','指定审核人员','Drop-down List1','FComboBox1','FChecker','t_YXSetEntry','',2,1,2047,0,1,1,8,'',0,9999,'SQL{ SELECT FUserID,FName  FROM t_user WHERE  1=1}','FUserID','t_user','t_user1','FName','',1,'','',231,500,255,255,'','','',1,'','',8010,1170,330,3195,'5',30,24,0,0,0,0,'',24631,'',9,'','',0,2,0,0,0,0,0,'',0) 
GO

INSERT INTO ICClassTableInfo(FClassTypeID,FPage,FCaption_CHS,FCaption_CHT,FCaption_EN,FKey,FFieldName,FTableName,FTableNameAs,FListIndex,FListClassName,FVisible,FEnable,FNeedSave,FMustInput,FCtlType,FProperty,FLookUpType,FLookUpClassID,FLookUpList,FSRCFieldName,FSRCTableName,FSRCTableNameAs,FDSPFieldName,FFNDFieldName,FValueLocation,FFilter,FFilterGroup,FValueType,FDspColType,FEditlen,FValuePrecision,FSaveRule,FDefValue,FAction,FUserDefine,FNote,FKeyWord,FLeft,FTop,FHeight,FWidth,FCondition,FTabIndex,FLock,FSum,FPrec,FScale,FLayer,FLoadAction,FUnControl,FFont,FSourceType,FSubKey,FParentKey,FConditionExt,FFrameBorder,FFrameBorderColor,FLabelWidth,FLabelColor,FTextColor,FIsF7,FContainer,FStyle) 
VALUES (200000004,2,'内码','內碼','ISN','FID2','FID','t_YXSetEntry','',0,1,0,1,1,1,3,'',0,0,'','','','','','',1,'','',56,500,255,4,'','','',1,'内码','PARENTID',240,120,350,0,'-1',-1,24,0,0,0,0,'',8193,'',0,'','',0,0,0,0,0,0,0,'',0) 
GO

INSERT INTO ICClassTableInfo(FClassTypeID,FPage,FCaption_CHS,FCaption_CHT,FCaption_EN,FKey,FFieldName,FTableName,FTableNameAs,FListIndex,FListClassName,FVisible,FEnable,FNeedSave,FMustInput,FCtlType,FProperty,FLookUpType,FLookUpClassID,FLookUpList,FSRCFieldName,FSRCTableName,FSRCTableNameAs,FDSPFieldName,FFNDFieldName,FValueLocation,FFilter,FFilterGroup,FValueType,FDspColType,FEditlen,FValuePrecision,FSaveRule,FDefValue,FAction,FUserDefine,FNote,FKeyWord,FLeft,FTop,FHeight,FWidth,FCondition,FTabIndex,FLock,FSum,FPrec,FScale,FLayer,FLoadAction,FUnControl,FFont,FSourceType,FSubKey,FParentKey,FConditionExt,FFrameBorder,FFrameBorderColor,FLabelWidth,FLabelColor,FTextColor,FIsF7,FContainer,FStyle) 
VALUES (200000004,2,'名称','名稱','Name','FParentName','FName','t_YXSetEntry','',4,1,0,1,1,0,1,'',0,0,'','','','','','',1,'','',167,500,255,255,'','','',1,'名称','',4435,840,350,2200,'-1',-1,24,0,0,0,0,'',8193,'',0,'','',0,0,0,0,0,0,0,'',0) 
GO

INSERT INTO ICClassTableInfo(FClassTypeID,FPage,FCaption_CHS,FCaption_CHT,FCaption_EN,FKey,FFieldName,FTableName,FTableNameAs,FListIndex,FListClassName,FVisible,FEnable,FNeedSave,FMustInput,FCtlType,FProperty,FLookUpType,FLookUpClassID,FLookUpList,FSRCFieldName,FSRCTableName,FSRCTableNameAs,FDSPFieldName,FFNDFieldName,FValueLocation,FFilter,FFilterGroup,FValueType,FDspColType,FEditlen,FValuePrecision,FSaveRule,FDefValue,FAction,FUserDefine,FNote,FKeyWord,FLeft,FTop,FHeight,FWidth,FCondition,FTabIndex,FLock,FSum,FPrec,FScale,FLayer,FLoadAction,FUnControl,FFont,FSourceType,FSubKey,FParentKey,FConditionExt,FFrameBorder,FFrameBorderColor,FLabelWidth,FLabelColor,FTextColor,FIsF7,FContainer,FStyle) 
VALUES (200000004,2,'代码','代碼','Code','FParentNumber','FNumber','t_YXSetEntry','',2,1,0,1,1,0,1,'',0,0,'','','','','','',1,'','',167,500,255,255,'','','',1,'代码','',3655,300,350,2200,'-1',-1,24,0,0,0,0,'',8193,'',0,'','',0,0,0,0,0,0,0,'',0) 
GO

/****** Object:Data   单据模板通用控件描述：ICClassCtl    Script Date: 2013-09-06 ******/

Delete ICClassCtl WHERE FClassTypeID=200000004
GO
/****** Object:Data   单据多布局列表：ICClassLayout    Script Date: 2013-09-06 ******/

--Delete ICClassLayout WHERE FClassTypeID = 200000004
GO
/****** Object:Data   单据多布局明细：ICClassTableInfoLayout    Script Date: 2013-09-06 ******/

--Delete ICClassTableInfoLayout WHERE FClassTypeID = 200000004
GO
/****** Object:Data   单据多布局通用控件明细：ICClassCtlLayout    Script Date: 2013-09-06 ******/

--Delete ICClassCtlLayout WHERE FClassTypeID = 200000004
GO
/****** Object:Data   单据多布局的Page明细：ICClassBillEntryLayout    Script Date: 2013-09-06 ******/

--Delete ICClassBillEntryLayout WHERE FClassTypeID = 200000004
GO
/****** Object:Data   单据模板单据布局控件描述：ICClassEntryEditorLayout    Script Date: 2013-09-06 ******/

--Delete ICClassEntryEditorLayout WHERE FClassTypeID = 200000004 and FLayoutID = 0
GO
/****** Object:Data   序时簿综合查询设置主关系表：icCLassUnionQuery    Script Date: 2013-09-06 ******/

--DELETE icCLassUnionQuery WHERE FSourClassTypeID=200000004
GO
/****** Object:Data   序时簿综合查询设置配置表：icCLassUnionQueryEntry    Script Date: 2013-09-06 ******/

--DELETE icCLassUnionQueryEntry WHERE FSourClassTypeID=200000004
GO
/****** Object:Data   单据权限类弄表：t_ObjectAccessType    Script Date: 2013-09-06 ******/

----Delete t_ObjectAccessType WHERE FObjectType=4100 And FObjectID =200000004
--GO
...
--VALUES (4100,200000004,1,2097152,1048576,'查看','查看','查看','View','查看','View') 
--GO

--INSERT INTO t_ObjectAccessType(FObjectType,FObjectID,FIndex,FAccessMask,FAccessUse,FName,FDescription,FName_cht,FName_en,FDescription_cht,FDescription_en) 
--VALUES (4100,200000004,2,131072,3145728,'新增','新增','新增','New','新增','New') 
--GO

--INSERT INTO t_ObjectAccessType(FObjectType,FObjectID,FIndex,FAccessMask,FAccessUse,FName,FDescription,FName_cht,FName_en,FDescription_cht,FDescription_en) 
--VALUES (4100,200000004,3,65536,3145728,'删除','删除','刪除','Delete','刪除','Delete') 
--GO

--INSERT INTO t_ObjectAccessType(FObjectType,FObjectID,FIndex,FAccessMask,FAccessUse,FName,FDescription,FName_cht,FName_en,FDescription_cht,FDescription_en) 
--VALUES (4100,200000004,4,4194304,3145728,'修改','修改','修改','Edit','修改','Edit') 
--GO

--INSERT INTO t_ObjectAccessType(FObjectType,FObjectID,FIndex,FAccessMask,FAccessUse,FName,FDescription,FName_cht,FName_en,FDescription_cht,FDescription_en) 
--VALUES (4100,200000004,5,64,3145728,'禁用','禁用','禁用','Disable','禁用','Disable') 
--GO

--INSERT INTO t_ObjectAccessType(FObjectType,FObjectID,FIndex,FAccessMask,FAccessUse,FName,FDescription,FName_cht,FName_en,FDescription_cht,FDescription_en) 
--VALUES (4100,200000004,6,16,3145728,'引出内部数据','引出内部数据','引出內部資料','Export Internal Data','引出內部資料','Export Internal Data') 
--GO

--INSERT INTO t_ObjectAccessType(FObjectType,FObjectID,FIndex,FAccessMask,FAccessUse,FName,FDescription,FName_cht,FName_en,FDescription_cht,FDescription_en) 
--VALUES (4100,200000004,7,16384,0,'导出单据模板','导出单据模板','導出單據模板','Export Doc Template','導出單據模板','Export Doc Template') 
--GO

--INSERT INTO t_ObjectAccessType(FObjectType,FObjectID,FIndex,FAccessMask,FAccessUse,FName,FDescription,FName_cht,FName_en,FDescription_cht,FDescription_en) 
--VALUES (4100,200000004,8,32768,3145728,'打印','打印','列印','Print','列印','Print') 
--GO

/****** Object:Data   单据权限对象表：t_ObjectType    Script Date: 2013-09-06 ******/

Delete t_ObjectType WHERE FObjectType=4100 And FObjectID =200000004
GO
INSERT INTO t_ObjectType(FObjectType,FObjectID,FName,FDescription,FName_cht,FName_en,FDescription_cht,FDescription_en) 
VALUES (4100,200000004,'同步数据配置表','','基礎資料200000004','Master Data200000004',NULL,NULL) 
GO

/****** Object:Data   单据权限表：t_ObjectAccess    Script Date: 2013-09-06 ******/

Delete t_ObjectAccess WHERE FObjectType=4100 And FObjectID =200000004
GO
INSERT INTO t_ObjectAccess(FGroupID,FObjectType,FObjectID,FIndex) 
VALUES (2101,4100,200000004,0) 
GO

INSERT INTO t_ObjectAccess(FGroupID,FObjectType,FObjectID,FIndex) 
VALUES (2101,4100,200000004,1) 
GO

INSERT INTO t_ObjectAccess(FGroupID,FObjectType,FObjectID,FIndex) 
VALUES (2102,4100,200000004,0) 
GO

INSERT INTO t_ObjectAccess(FGroupID,FObjectType,FObjectID,FIndex) 
VALUES (2102,4100,200000004,1) 
GO

INSERT INTO t_ObjectAccess(FGroupID,FObjectType,FObjectID,FIndex) 
VALUES (2102,4100,200000004,2) 
GO

INSERT INTO t_ObjectAccess(FGroupID,FObjectType,FObjectID,FIndex) 
VALUES (2102,4100,200000004,3) 
GO

INSERT INTO t_ObjectAccess(FGroupID,FObjectType,FObjectID,FIndex) 
VALUES (2102,4100,200000004,4) 
GO

INSERT INTO t_ObjectAccess(FGroupID,FObjectType,FObjectID,FIndex) 
VALUES (2102,4100,200000004,5) 
GO

INSERT INTO t_ObjectAccess(FGroupID,FObjectType,FObjectID,FIndex) 
VALUES (2102,4100,200000004,6) 
GO

INSERT INTO t_ObjectAccess(FGroupID,FObjectType,FObjectID,FIndex) 
VALUES (2102,4100,200000004,7) 
GO

INSERT INTO t_ObjectAccess(FGroupID,FObjectType,FObjectID,FIndex) 
VALUES (2102,4100,200000004,8) 
GO

/****** Object:Data   选单关联：ICClassLink    Script Date: 2013-09-06 ******/

Delete ICClassLink WHERE FDestClassTypeID = 200000004 OR FSourClassTypeID =  200000004
GO
/****** Object:Data   选单关联明细：ICClassLinkEntry    Script Date: 2013-09-06 ******/

Delete ICClassLinkEntry WHERE FDestClassTypeID=200000004 OR FSourClassTypeID =  200000004
GO
/****** Object:Data   选单钩稽明细：ICClassLinkCommit    Script Date: 2013-09-06 ******/

 DELETE ICClassLinkCommit WHERE FDstClsTypID = 200000004 OR FSrcClsTypID =  200000004
GO
...
DELETE ICClassWorkFlowBill WHERE FClassTypeID = 200000004
GO
...
/****** Object:Data   选单流程关联关系：ICClassWorkFlowJoin    Script Date: 2013-09-06 ******/
 ...
 DELETE ICClassWorkFlowJoin WHERE FDestClassTypeID = 200000004 OR FSourClassTypeID = 200000004
GO
...
Delete ICClassMutex WHERE FClassTypeID=200000004
GO
/****** Object:Data   网络控制互斥表明细数据：t_Mutex    Script Date: 2013-09-06 ******/

DELETE t_Mutex 
WHERE FFuncId IN
(Select FFuncID from icClassMutex where FClassTypeID=200000004)
OR FForbidden IN
(Select FFuncID from icClassMutex where FClassTypeID=200000004)
...
VALUES ( @MaxID + 1,200000004,'mnuEditCopy','复制','複製','Copy','复制','複製','Copy',39,131072,0,7,1,0,1,0,0,1,0) 

INSERT INTO ICClassBillAction(FID,FClassTypeID,FCode,FName_CHS,FName_CHT,FName_EN,FDescriptions_CHS,FDescriptions_CHT,FDescriptions_EN,FEnvironment,FRightMask,FRightUseMask,FRightGroupMask,FRightControl,FAddLog,FIsPredefine,FIsFirst,FShortCut,FListActionCirculation,FOperationType) 
VALUES ( @MaxID + 2,200000004,'mnuEditDel','删除','刪除','Delete','删除','刪除','Delete',4096,65536,0,7,1,1,1,0,0,1,0) 

INSERT INTO ICClassBillAction(FID,FClassTypeID,FCode,FName_CHS,FName_CHT,FName_EN,FDescriptions_CHS,FDescriptions_CHT,FDescriptions_EN,FEnvironment,FRightMask,FRightUseMask,FRightGroupMask,FRightControl,FAddLog,FIsPredefine,FIsFirst,FShortCut,FListActionCirculation,FOperationType) 
VALUES ( @MaxID + 3,200000004,'mnuEditDelGroup','删除组','刪除組','Delete Group ','删除组','刪除組','Delete Group ',4096,65536,0,7,1,1,1,0,0,1,0) 

INSERT INTO ICClassBillAction(FID,FClassTypeID,FCode,FName_CHS,FName_CHT,FName_EN,FDescriptions_CHS,FDescriptions_CHT,FDescriptions_EN,FEnvironment,FRightMask,FRightUseMask,FRightGroupMask,FRightControl,FAddLog,FIsPredefine,FIsFirst,FShortCut,FListActionCirculation,FOperationType) 
VALUES ( @MaxID + 4,200000004,'mnuEditModify','修改','修改','Edit','修改','修改','Edit',4160,4194304,0,7,1,0,1,0,0,1,0) 

INSERT INTO ICClassBillAction(FID,FClassTypeID,FCode,FName_CHS,FName_CHT,FName_EN,FDescriptions_CHS,FDescriptions_CHT,FDescriptions_EN,FEnvironment,FRightMask,FRightUseMask,FRightGroupMask,FRightControl,FAddLog,FIsPredefine,FIsFirst,FShortCut,FListActionCirculation,FOperationType) 
VALUES ( @MaxID + 5,200000004,'mnuEditUnuse','禁用','禁用','Disabled','禁用','禁用','Disabled',4096,64,0,7,1,1,1,0,0,1,0) 

INSERT INTO ICClassBillAction(FID,FClassTypeID,FCode,FName_CHS,FName_CHT,FName_EN,FDescriptions_CHS,FDescriptions_CHT,FDescriptions_EN,FEnvironment,FRightMask,FRightUseMask,FRightGroupMask,FRightControl,FAddLog,FIsPredefine,FIsFirst,FShortCut,FListActionCirculation,FOperationType) 
VALUES ( @MaxID + 6,200000004,'mnuEditUse','反禁用','反禁用','Enable','反禁用','反禁用','Enable',4096,64,0,7,1,1,1,0,0,1,0) 

INSERT INTO ICClassBillAction(FID,FClassTypeID,FCode,FName_CHS,FName_CHT,FName_EN,FDescriptions_CHS,FDescriptions_CHT,FDescriptions_EN,FEnvironment,FRightMask,FRightUseMask,FRightGroupMask,FRightControl,FAddLog,FIsPredefine,FIsFirst,FShortCut,FListActionCirculation,FOperationType) 
VALUES ( @MaxID + 7,200000004,'mnuExportData','引出内部数据','引出內部資料','Export Internal Data','引出内部数据','引出內部資料','Export Internal Data',5056,16,0,7,1,0,1,0,0,1,0) 

INSERT INTO ICClassBillAction(FID,FClassTypeID,FCode,FName_CHS,FName_CHT,FName_EN,FDescriptions_CHS,FDescriptions_CHT,FDescriptions_EN,FEnvironment,FRightMask,FRightUseMask,FRightGroupMask,FRightControl,FAddLog,FIsPredefine,FIsFirst,FShortCut,FListActionCirculation,FOperationType) 
VALUES ( @MaxID + 8,200000004,'mnuFileExportBillTpl','导出单据模板','導出單據模板','Export Doc Template','导出单据模板','導出單據模板','Export Doc Template',0,16384,0,7,1,1,1,0,0,1,0) 

INSERT INTO ICClassBillAction(FID,FClassTypeID,FCode,FName_CHS,FName_CHT,FName_EN,FDescriptions_CHS,FDescriptions_CHT,FDescriptions_EN,FEnvironment,FRightMask,FRightUseMask,FRightGroupMask,FRightControl,FAddLog,FIsPredefine,FIsFirst,FShortCut,FListActionCirculation,FOperationType) 
VALUES ( @MaxID + 9,200000004,'mnuFileImportBill','导入单据数据','導入單據資料','Import Doc Data','导入单据数据','導入單據資料','Import Doc Data',0,16384,0,7,1,1,1,0,0,1,0) 

INSERT INTO ICClassBillAction(FID,FClassTypeID,FCode,FName_CHS,FName_CHT,FName_EN,FDescriptions_CHS,FDescriptions_CHT,FDescriptions_EN,FEnvironment,FRightMask,FRightUseMask,FRightGroupMask,FRightControl,FAddLog,FIsPredefine,FIsFirst,FShortCut,FListActionCirculation,FOperationType) 
VALUES ( @MaxID + 10,200000004,'mnuFileNewGroup','新增组','新增組','New Group','新增组','新增組','New Group',4096,131072,0,7,1,0,1,0,0,1,0) 

INSERT INTO ICClassBillAction(FID,FClassTypeID,FCode,FName_CHS,FName_CHT,FName_EN,FDescriptions_CHS,FDescriptions_CHT,FDescriptions_EN,FEnvironment,FRightMask,FRightUseMask,FRightGroupMask,FRightControl,FAddLog,FIsPredefine,FIsFirst,FShortCut,FListActionCirculation,FOperationType) 
VALUES ( @MaxID + 11,200000004,'mnuFileNewItem','新增项目','新增項目','New Item','新增项目','新增項目','New Item',4096,131072,0,7,1,0,1,0,0,1,0) 

INSERT INTO ICClassBillAction(FID,FClassTypeID,FCode,FName_CHS,FName_CHT,FName_EN,FDescriptions_CHS,FDescriptions_CHT,FDescriptions_EN,FEnvironment,FRightMask,FRightUseMask,FRightGroupMask,FRightControl,FAddLog,FIsPredefine,FIsFirst,FShortCut,FListActionCirculation,FOperationType) 
VALUES ( @MaxID + 12,200000004,'mnuFilePrint','打印','列印','Print','打印','列印','Print',5095,32768,0,7,1,0,1,0,0,1,0) 

INSERT INTO ICClassBillAction(FID,FClassTypeID,FCode,FName_CHS,FName_CHT,FName_EN,FDescriptions_CHS,FDescriptions_CHT,FDescriptions_EN,FEnvironment,FRightMask,FRightUseMask,FRightGroupMask,FRightControl,FAddLog,FIsPredefine,FIsFirst,FShortCut,FListActionCirculation,FOperationType) 
VALUES ( @MaxID + 13,200000004,'mnuFileSave','保存','保存','Save','保存','保存','Save',6,0,0,7,0,1,1,0,0,1,0) 

INSERT INTO ICClassBillAction(FID,FClassTypeID,FCode,FName_CHS,FName_CHT,FName_EN,FDescriptions_CHS,FDescriptions_CHT,FDescriptions_EN,FEnvironment,FRightMask,FRightUseMask,FRightGroupMask,FRightControl,FAddLog,FIsPredefine,FIsFirst,FShortCut,FListActionCirculation,FOperationType) 
VALUES ( @MaxID + 14,200000004,'mnuStockQuery','库存查询','庫存查詢','Query Inventory','库存查询','庫存查詢','Query Inventory',0,0,0,7,0,1,1,0,0,1,0) 
...
DELETE t_LogFunction WHERE FFunctionID LIKE 'BOS200000004%'
GO
INSERT INTO t_LogFunction(FFunctionID,FFunctionName,FSubSysID,FFunctionName_Cht,FFunctionName_EN) 
VALUES ('BOS200000004_mnuEditDel','销售管理系统-同步数据配置表',23,'銷售管理系統-基礎資料200000004','Sales Module-Master Data200000004') 
GO

INSERT INTO t_LogFunction(FFunctionID,FFunctionName,FSubSysID,FFunctionName_Cht,FFunctionName_EN) 
VALUES ('BOS200000004_mnuEditDelGroup','销售管理系统-同步数据配置表',23,'銷售管理系統-基礎資料200000004','Sales Module-Master Data200000004') 
GO

INSERT INTO t_LogFunction(FFunctionID,FFunctionName,FSubSysID,FFunctionName_Cht,FFunctionName_EN) 
VALUES ('BOS200000004_mnuEditUnuse','销售管理系统-同步数据配置表',23,'銷售管理系統-基礎資料200000004','Sales Module-Master Data200000004') 
GO

INSERT INTO t_LogFunction(FFunctionID,FFunctionName,FSubSysID,FFunctionName_Cht,FFunctionName_EN) 
VALUES ('BOS200000004_mnuEditUse','销售管理系统-同步数据配置表',23,'銷售管理系統-基礎資料200000004','Sales Module-Master Data200000004') 
GO

INSERT INTO t_LogFunction(FFunctionID,FFunctionName,FSubSysID,FFunctionName_Cht,FFunctionName_EN) 
VALUES ('BOS200000004_mnuFileExportBillTpl','销售管理系统-同步数据配置表',23,'銷售管理系統-基礎資料200000004','Sales Module-Master Data200000004') 
GO

INSERT INTO t_LogFunction(FFunctionID,FFunctionName,FSubSysID,FFunctionName_Cht,FFunctionName_EN) 
VALUES ('BOS200000004_mnuFileImportBill','销售管理系统-同步数据配置表',23,'銷售管理系統-基礎資料200000004','Sales Module-Master Data200000004') 
GO

INSERT INTO t_LogFunction(FFunctionID,FFunctionName,FSubSysID,FFunctionName_Cht,FFunctionName_EN) 
VALUES ('BOS200000004_mnuFileSave','销售管理系统-同步数据配置表',23,'銷售管理系統-基礎資料200000004','Sales Module-Master Data200000004') 
GO

INSERT INTO t_LogFunction(FFunctionID,FFunctionName,FSubSysID,FFunctionName_Cht,FFunctionName_EN) 
VALUES ('BOS200000004_mnuStockQuery','销售管理系统-同步数据配置表',23,'銷售管理系統-基礎資料200000004','Sales Module-Master Data200000004') 
GO

/****** Object:Data   单据操作位置模板数据：ICClassActionPosition    Script Date: 2013-09-06 ******/

DELETE ICClassActionPosition WHERE FClassTypeID = 200000004
GO
/****** Object:Data   单据扩展服务模板数据：ICClassActionList    Script Date: 2013-09-06 ******/

DELETE ICClassActionList WHERE FClassTypeID = 200000004
GO
...
VALUES (200000004,6,'FName',0,4096,'FAction','FParentName','',1,'Update By Function UpdateOldFiledAction') 
GO

INSERT INTO ICClassActionList(FClassTypeID,FClassActionID,FObject,FDefineType,FSourceType,FSourceField,FAction,FExpression,FOrder,FDescription) 
VALUES (200000004,6,'FNumber',0,4096,'FAction','FParentNumber','',1,'Update By Function UpdateOldFiledAction') 
GO

INSERT INTO ICClassActionList(FClassTypeID,FClassActionID,FObject,FDefineType,FSourceType,FSourceField,FAction,FExpression,FOrder,FDescription) 
VALUES (200000004,12,'FNumber',0,4096,'FSaveRule','FNumber','',1,'Update By Function UpdateOldFiledAction') 
GO
...
----------------------------------------------------------
----------------------------------------------------------
----------SELECT* FROM update ICStockBill SET FSynchroID=null  WHERE FSynchroID>0
--
--添加BOM字段
...
--    INSERT INTO t_ICItemCustom(F_101,F_102,F_103,F_105,FItemID) SELECT  isnull(F_101,0),isnull(F_102,0),F_103,F_105,FItemID FROM Inserted  
--        END  
--        IF (@@error <> 0)    
--            ROLLBACK TRANSACTION    
--        ELSE    
...
begin
	...
	begin
	   ...
	   begin
		...
		set @Sql='insert into ' + @DBName + '.dbo.ICStockBillEntry(FBrNo,FInterID,FEntryID,FBatchNo,FNote,
				...
				FEntrySelfA0156,	FEntrySelfA0157,	FEntrySelfA0158,	FEntrySelfB0158,	FEntrySelfB0162,	
			            FEntrySelfB0163,	FEntrySelfB0164,	FEntrySelfA0160,	FEntrySelfA0161,	FEntrySelfA0162,	
			            FEntrySelfA0163,	FEntrySelfB0165,	FEntrySelfB0160,	FEntrySelfB0161,	FEntrySelfB0159,	
			            FEntrySelfB0168,	FEntrySelfA0165,	FEntrySelfA0166,	FEntrySelfB0167,	FEntrySelfB0169,FPriceRef,  FAuxPriceRef,FAmtRef  ) '+
		...
		begin
			...
			exec(@sql)
			--2014-11-28 yexuefeng add AutoICPurchase		
				if @FTranType=1--生成采购发票
			BEGIN
			SET @Sql='EXEC ' + @DBName+'.dbo.sp_tb_icstockbill_1Auto_ICPurchase '+cast(@pp as varchar(10))
		...
		begin
			...
			set @Sql='insert into ' + @DBName+'.dbo.ICInventory(FBrNo,FItemID,FBatchNo,FMTONo,FAuxPropID,FStockID,FStockPlaceID,FKFPeriod,FKFDate,FQty,FSecQty)
				...
				where t1.FItemID is null'
			exec(@sql)
					----2014-11-28 yexuefeng add AutoIcsale
	...
	begin
------*********************** 此处要改目标帐套名*****************************************	
	  IF EXISTS(select 1 from CON14.AIS_yxry2_2.dbo.ICStockBill where isnull(FCheckerID,0)>0 and FInterID= @FSynchroID)
------*********************** 此处要改目标帐套名*****************************************
  begin
...
--SELECT TOP 1 @FCheckerID=isnull(FProcessUserID,0)@FCheckerID=isnull(FChecker,0),  FROM ICClassMCTaskCenter where FClassTypeID = @FClassTypeID  AND fbillid=@FInterID ORDER BY fid desc
  ...
  --      set @BNoSql =' exec '+ @DBName+'.dbo.Pro_BosBillNo  ''XSKD'',40020,@p2 output'
		...
		set @sql = 
			...
			FReceiveAmountFor,FDiscountAmount,FDiscountAmountFor,FContractID,FRP,FPre,FTranType_CN,FBankAcctName) '+
		...
		update t_RP_NewReceiveBill  set FSynchroID= @pp   where FBillID=@FInterID 
         ...
         exec(@sql)   
         END 
          IF @FClassTypeID=1000016
         BEGIN
           SET @sql='INSERT INTO ' + @DBName + '.dbo.ICClassCheckRecords1000016( FPage ,FBillID , FBillEntryID ,FBillNo ,FBillEntryIndex ,FCheckLevel ,
                   FCheckLevelTo ,FMode ,FCheckMan ,FCheckIdea ,FCheckDate ,FDescriptions)
                   SELECT  1 FPage ,FBillID ,0 FBillEntryID ,FNumber  FBillNo ,0 FBillEntryIndex , -99 FCheckLevel ,
                   -1 FCheckLevelTo ,0  FMode ,FChecker FCheckMan ,''''  FCheckIdea ,FCheckDate ,''审核''  FDescriptions
                   FROM ' + @DBName + '.dbo.t_RP_NewReceiveBill WHERE FBillID in ('+cast(@pp as varchar(10))+') UNION
	...
	begin
--**************************************************
		  IF EXISTS(select 1 from CON14.AIS_yxry2_2.dbo.t_RP_NewReceiveBill where isnull(FChecker,0)>0 and FBillID= @FSynchroID)
--**************************************************
...
DECLARE @F1 integer,@F2 integer,@F3 integer,@F8 integer,@F3001 integer,@FdetailCount INTEGER,@FdetailIDMax INTEGER
DECLARE itemdetail_cursor CURSOR FOR
 --********************************************************
    SELECT a.* FROM   (SELECT ISNULL((SELECT TOP 1 Fitemid FROM CON14.AIS_yxry2_2.dbo.t_item WHERE  FItemClassID=1 AND  FNumber =ISNULL((SELECT TOP 1 fnumber FROM t_item WHERE  FItemClassID=1 AND  FItemID=f1),0)),0) AS F1,
  ISNULL((SELECT TOP 1 Fitemid FROM CON14.AIS_yxry2_2.dbo.t_item WHERE FItemClassID=2 AND FNumber =ISNULL((SELECT TOP 1 fnumber FROM t_item WHERE FItemClassID=2 AND FItemID=f2),0)),0) AS F2,
  ISNULL((select TOP 1 Fitemid FROM CON14.AIS_yxry2_2.dbo.t_item WHERE FItemClassID=3 AND FNumber =ISNULL((SELECT TOP 1 fnumber FROM t_item WHERE FItemClassID=3 AND FItemID=f3),0)),0) AS F3,
  ISNULL((select TOP 1 Fitemid FROM CON14.AIS_yxry2_2.dbo.t_item WHERE FItemClassID=8 AND FNumber =ISNULL((SELECT TOP 1 fnumber FROM t_item WHERE FItemClassID=8 AND FItemID=f8),0)),0) AS F8,
  ISNULL((select TOP 1 Fitemid FROM CON14.AIS_yxry2_2.dbo.t_item WHERE FItemClassID=3001 AND FNumber =ISNULL((SELECT TOP 1 fnumber FROM t_item WHERE FItemClassID=3001 AND FItemID=F3001),0)),0) AS F3001,
  a.FdetailCount 
  --****************************************************************
   FROM t_itemdetail a,t_VoucherEntry b WHERE a.FDetailID=b.FDetailID AND b.FVoucherID=@FinterID AND a.FDetailID>0 ) a ,CON14.AIS_yxry2_2.dbo.t_itemdetail b 
   WHERE a.f1<>b.f1 AND a.f2<>b.f2 AND a.f3<>b.f3 AND a.f8<>b.f8 AND a.f3001<>b.f3001 
OPEN itemdetail_cursor 
 
FETCH next  FROM itemdetail_cursor into @F1,@F2,@F3,@F8,@F3001,@FdetailCount
WHILE @@FETCH_STATUS = 0
BEGIN
--****************************************************
SELECT @FdetailIDMax=ISNULL(MAX(FdetailID)+1,0) FROM CON14.AIS_yxry2_2.dbo.t_itemdetail
INSERT INTO CON14.AIS_yxry2_2.dbo.T_itemdetail (F1,F2,F3,F8,F3001,FdetailCount,FdetailID)
SELECT ISNULL(@F1,0),ISNULL(@F2,0),ISNULL(@F3,0),ISNULL(@F8,0),ISNULL(@f3001,0),ISNULL(@FdetailCount,0),@FdetailIDMax 

IF @F1>0
     insert into t_itemdetailv(fdetailid, fitemclassid, fitemid) 
     --*****************************************************
	 select fdetailid,ISNULL((select TOP 1 fitemclassid FROM CON14.AIS_yxry2_2.dbo.t_Item WHERE  FItemClassID=1 AND  FItemID=@F1),0),ISNULL(@F1,0)  from CON14.AIS_yxry2_2.dbo.t_itemdetail where  FDetailID=@FdetailIDMax
	 IF @F2>0
     insert into t_itemdetailv(fdetailid, fitemclassid, fitemid) 
     --********************************************************
	 select fdetailid,ISNULL((select TOP 1 fitemclassid FROM CON14.AIS_yxry2_2.dbo.t_Item WHERE FItemClassID=2 AND FItemID=@F2),0),ISNULL(@F2,0)  from CON14.AIS_yxry2_2.dbo.t_itemdetail where  FDetailID=@FdetailIDMax
	 IF @F3>0
     insert into t_itemdetailv(fdetailid, fitemclassid, fitemid) 
	 select fdetailid,ISNULL((select TOP 1 fitemclassid FROM CON14.AIS_yxry2_2.dbo.t_Item WHERE FItemClassID=3 AND FItemID=@F3),0),ISNULL(@F3,0)  from CON14.AIS_yxry2_2.dbo.t_itemdetail where  FDetailID=@FdetailIDMax
	 IF @F8>0
     insert into t_itemdetailv(fdetailid, fitemclassid, fitemid) 
	 select fdetailid,ISNULL((select TOP 1 fitemclassid FROM CON14.AIS_yxry2_2.dbo.t_Item WHERE FItemClassID=8 AND FItemID=@F8),0),ISNULL(@F8,0)  from CON14.AIS_yxry2_2.dbo.t_itemdetail where  FDetailID=@FdetailIDMax
	  ---20150422yxf add
	  IF @F3001>0
     insert into t_itemdetailv(fdetailid, fitemclassid, fitemid) 
	 select fdetailid,ISNULL((select TOP 1 fitemclassid FROM CON14.AIS_yxry2_2.dbo.t_Item WHERE FItemClassID=3001 AND FItemID=@F3001),0),ISNULL(@F3001,0)  from CON14.AIS_yxry2_2.dbo.t_itemdetail where  FDetailID=@FdetailIDMax
...
--**************************************
UPDATE a SET FNext=FNext+1 FROM CON14.AIS_yxry2_2.dbo.t_Identity a WHERE FName='t_Voucher'
SELECT TOP 1 @pp=FNext FROM CON14.AIS_yxry2_2.dbo.t_Identity WHERE FName='t_Voucher'
...
isnull((SELECT top 1 isnull(b.FDetailID,0) FROM   (SELECT ISNULL((SELECT TOP 1 Fitemid FROM  ' + @DBName + '.dbo.t_item WHERE FItemClassID=1 AND FNumber =ISNULL((SELECT TOP 1 fnumber FROM t_item WHERE FItemClassID=1 AND FItemID=f1),0)),0) AS F1,
  ...
  ISNULL((select TOP 1 Fitemid FROM  ' + @DBName + '.dbo.t_item WHERE FItemClassID=3001 AND FNumber =ISNULL((SELECT TOP 1 fnumber FROM t_item WHERE FItemClassID=3001 AND FItemID=f3001),0)),0) AS F3001,
  
  a.FdetailCount 
   FROM t_itemdetail a WHERE a.FDetailID=t.FDetailID AND a.FDetailID>0 ) a , ' + @DBName + '.dbo.t_itemdetail b 
   WHERE a.FdetailCount=b.FDetailCount AND a.f1=b.f1 AND a.f2=b.f2 AND a.f3=b.f3 AND a.f8=b.f8 and a.f3001=b.f3001),0)
...
exec(@sql)
   ...
   --更新凭证号填充断号
  SET @sql= ' EXEC ' + @DBName + '.dbo.sp_update_t_Voucher_fnumber '+cast(@pp as varchar(10))
   exec(@sql)
  --更新源凭证的关联目标的凭证号
  
  SET @sql='update  t_Voucher  set FSynchroIDNum=(select FNumber from ' + @DBName + '.dbo.t_Voucher   where FVoucherID='+CAST(@pp AS VARCHAR) +') where FVoucherID='+@FInterID 
   exec(@sql)
...
--*********************************************************
					  IF EXISTS(select 1 from CON14.AIS_yxry2_2.dbo.t_rp_arpbill where isnull(FChecker,0)>0 and FBillID= @FSynchroID)
