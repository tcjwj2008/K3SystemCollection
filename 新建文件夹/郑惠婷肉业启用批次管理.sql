...
INSERT into #abc(物料代码,旧批次,新批次) values('8.1.02.00150','AA','201908');
insert into #abc(物料代码,旧批次,新批次) values('8.1.02.00160','AA','201908');
...
--查询出入库
SELECT b.FBatchNo,a.旧批次,a.新批次 ,b.finterid FROM dbo.ICStockBillEntry b
INNER JOIN #abc a ON b.FItemID=a.内码 AND b.FBatchNo=a.旧批次
