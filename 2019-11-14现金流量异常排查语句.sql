...
ORDER BY FYear ,
        ...
        FNumber; 
						...
						SELECT * FROM dbo.t_Voucher WHERE FPeriod=9 AND FYear=2019 AND FNumber=107
SELECT  FVoucherID AS 凭证内码,
        FYear 会计年度,
        FPeriod 会计期间,
        FNumber 凭证号
...
WHERE   FVoucherID IN (
        ...
        FROM    ( SELECT    X.FVoucherID ,
                ...
                ( SELECT    FVoucherID ,
                         --   FCashAccountID ,
                         CASE WHEN SUM(FFAmountFor)>0 THEN SUM(FFAmountFor) ELSE 
...
SELECT * FROM dbo.t_Voucher WHERE FPeriod=10 AND FYear=2019 AND FNumber=108
SELECT  FVoucherID AS 凭证内码,
        FYear 会计年度,
        FPeriod 会计期间,
        FNumber 凭证号
...
SELECT * FROM dbo.t_Voucher WHERE FPeriod=9 AND FYear=2019 AND FNumber=89
SELECT  FVoucherID AS 凭证内码,
        FYear 会计年度,
        FPeriod 会计期间,
        FNumber 凭证号
...
SELECT * FROM dbo.t_Voucher WHERE FPeriod=11 AND FYear=2019 AND FNumber=88
SELECT  FVoucherID AS 凭证内码,
        FYear 会计年度,
        FPeriod 会计期间,
        FNumber 凭证号
...
ORDER BY FYear ,
		...
		SELECT FVoucherID,fdc FROM dbo.t_VoucherEntry GROUP BY FVoucherID,FDC ORDER BY FVoucherID