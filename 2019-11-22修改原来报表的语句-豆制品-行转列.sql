...
AS
    BEGIN
        ...
        SELECT  @sql='SELECT CONVERT(VARCHAR(50), FDate, 23) as 日期 , 车次 , 客户代码 , 客户名称 ,客户地址 ,';
		SET @SQL1=(SELECT   'sum(case  品名规格 when  ''' + 品名规格
                            + ''' then 数量 end) [' + 品名规格 + '],'
